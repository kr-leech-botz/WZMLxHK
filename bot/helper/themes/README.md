...
2. **Sample File :** Check [tamilml_minimal.py](https://github.com/ThiruXD/Tamil-ML/blob/hk_tamilml/bot/helper/themes/tamilml_minimal.py)

---

#### ***Step 1:*** Open the Blank Editor and Paste the Codes of tamilml_minimal.py and name it `tamilml_custom.py`
You can give the `custom` as your choice, like `tamilml_futuristic.py`, etc
...
- _Things to Remember while Editing :_
  ...
  - Don't Change the Class name tamilmlStyle
  - Don't Use f-string like `f"{var}"`
***Sample Editing :***
```python
class tamilmlStyle: # Don't Change This
    ST_BN1_NAME = '{sb1n}'
...
```python
AVL_THEMES = {"minimal": tamilml_minimal, "emoji": tamilml_emoji, "futuristic": tamilml_futuristic} # You can add More ...
